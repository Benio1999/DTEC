...
form.addEventListener('submit', function (e) {
    ...
    if (altura === "" && peso === "" || altura === undefined && peso === undefined || altura == 0 && peso == 0) {
        resultado.innerHTML = `<p class='bad'>Peso e altura invalidos</p>`
    }
    else if (altura === "" || altura === undefined || altura == 0) {
